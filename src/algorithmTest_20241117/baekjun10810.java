...
public class baekjun10810 {
    public static void main(String[] args) throws IOException {
      ...
      int basketSize = Integer.parseInt(temp[0]);
      int testCase = Integer.parseInt(temp[1]);

      int[] bascet = new int[basketSize];

      for( int i = 0; i < testCase; i++){
        String[] temp2 = br.readLine().split(" ");

        int first = Integer.parseInt(temp2[0]);
        int last = Integer.parseInt(temp2[1]);
        int num = Integer.parseInt(temp2[2]);
