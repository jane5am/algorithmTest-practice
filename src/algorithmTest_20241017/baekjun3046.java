// 백준 3046번 R2 / 난이도 : 브론즈 4
// 메모리 : 14076KB, 시간 : 100ms
...
package algorithmTest_20241017;
...
public class baekjun3046 {
    public static void main(String[] args) throws IOException {
        ...
        int[] numArr = { Integer.parseInt(num[0]), Integer.parseInt(num[1]) };

        System.out.println(numArr[1] * 2 - numArr[0] );
